...
contatos_empreendedores = pd.read_excel("test.xlsx")
# contatos_empreendedores = pd.read_excel("Lista_de_Empreendedores.xlsx")


display(contatos_empreendedores)
...
for i, contato in enumerate(contatos_empreendedores['Contato']):
    try:
        pessoa = contatos_empreendedores.loc[i, "Nome do Empreendedor"].split()[0]
        numero_contato = contatos_empreendedores.loc[i, "Contato"]
